...
# 機器人的部件尺寸和顏色
body_parts = {
    "head": {"size": [0.8, 0.8, 0.8], "color": [0.0, 0.0, 1.0]},  # 藍色
    "torso": {"size": [1.5, 2, 0.5], "color": [0.0, 0.0, 1.0]},  # 藍色
    "upper_arm": {"size": [0.5, 1, 0.5], "color": [0.0, 0.0, 1.0]},  # 藍色
    "lower_arm": {"size": [0.4, 0.8, 0.4], "color": [0.0, 0.0, 1.0]}, # 藍色 
    "upper_leg": {"size": [0.6, 1.2, 0.6], "color": [0.0, 0.0, 1.0]},  # 藍色
    "lower_leg": {"size": [0.5, 1, 0.5], "color": [0.0, 0.0, 1.0]}  # 藍色
}
...
def draw_robot_running():
    ...
    leg_swing_angle = 45  # 腿部彎曲的角度
    arm_swing_angle = 35  # 手臂彎曲的角度  
